...
router.put("/dispatcher/:id",  authMiddleware, orderControllers.updateOrderByDispatcher);
router.put("/driver/:id",  authMiddleware, orderControllers.updateOrderByDriver);
router.put("/grade/client/:id", authMiddleware,  orderControllers.gradeOrderByClient);
router.put("/grade/driver/:id", authMiddleware,  orderControllers.gradeOrderByDriver);
